...
test("should throw when input is null or undefined", () => {
  expect(() => render(<ShoppingList items={null} />)).toThrowError();

  expect(() => render(<ShoppingList items={undefined} />)).toThrowError();
});
